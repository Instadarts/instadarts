...
/**
 * GitHub's own mark, from the MIT-licensed Octicons set, inlined like the rest of this file so it
 * follows `currentColor` into either theme. It appears only beside links that do lead to GitHub,
 * which is what GitHub's logo terms ask of it.
 */
